<p align="center">
  <img src="banner.svg" alt="estimated — git blame for your promises" width="780">
</p>

<h1 align="center">estimated · the page</h1>

<p align="center">The landing page for <a href="https://github.com/Artemoon13/estimated">estimated</a>, git blame for your promises.<br>
Plain HTML, CSS and JavaScript. No framework, no bundler, nothing to install to look at it.</p>

---

**Every line in its terminals was printed by the real program.** `data.js` is written by `build.py`, which builds the demo repository and runs `estimated` on it: the report, every task taken apart, `doctor`, `drift`, three looping films, and the exact wording of every refusal. The page does not write any of it.
...
```sh
git clone https://github.com/Artemoon13/estimated ../estimated
